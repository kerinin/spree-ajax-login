...
desc 'Generate documentation for the ajax_login extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'AjaxLoginExtension'
...
desc 'Test the ajax_login extension.'
...
namespace :test do
  desc 'Functional test the ajax_login extension.'
  ...
  desc 'Unit test the ajax_login extension.'
